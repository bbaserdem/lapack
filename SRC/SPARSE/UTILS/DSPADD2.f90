...
CONTAINS
    ...
    SUBROUTINE DSPADD2_COO(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        REAL(real64), INTENT(IN) :: ALPHA, BETA
        TYPE(sparse_coo_d), INTENT(IN) :: A, B
        TYPE(sparse_coo_d), INTENT(OUT) :: C
        INTEGER(int32), INTENT(OUT) :: INFO
        ...
        ! Special cases
        IF (ALPHA == 0.0_real64 .AND. BETA == 0.0_real64) THEN
            ! C = 0
            C%nrows = M
            C%ncols = N
            C%nnz = 0
        ...
        ! Call DSPCOMP afterwards to combine duplicates
    ...
    SUBROUTINE DSPADD2_CSR(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        REAL(real64), INTENT(IN) :: ALPHA, BETA
        TYPE(sparse_csr_d), INTENT(IN) :: A, B
        TYPE(sparse_csr_d), INTENT(OUT) :: C
        INTEGER(int32), INTENT(OUT) :: INFO
    ...
    SUBROUTINE DSPADD2_CSC(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        REAL(real64), INTENT(IN) :: ALPHA, BETA
        TYPE(sparse_csc_d), INTENT(IN) :: A, B
        TYPE(sparse_csc_d), INTENT(OUT) :: C
        INTEGER(int32), INTENT(OUT) :: INFO
