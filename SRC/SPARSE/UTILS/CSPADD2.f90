    ...
    IF (LSAME(FORMAT, 'O')) THEN
        ...
        TYPE IS (sparse_coo_c)
            ...
            TYPE IS (sparse_coo_c)
                SELECT TYPE(C)
                TYPE IS (sparse_coo_c)
                    CALL CSPADD2_COO(M, N, ALPHA, A, BETA, B, C, INFO)
                CLASS DEFAULT
                    INFO = -1
                END SELECT
            CLASS DEFAULT
    ...
    ELSE IF (LSAME(FORMAT, 'R')) THEN
        ...
        TYPE IS (sparse_csr_c)
            ...
            TYPE IS (sparse_csr_c)
                SELECT TYPE(C)
                TYPE IS (sparse_csr_c)
                    CALL CSPADD2_CSR(M, N, ALPHA, A, BETA, B, C, INFO)
                CLASS DEFAULT
                    INFO = -1
                END SELECT
            CLASS DEFAULT
    ...
    ELSE IF (LSAME(FORMAT, 'C')) THEN
        ...
        TYPE IS (sparse_csc_c)
            ...
            TYPE IS (sparse_csc_c)
                SELECT TYPE(C)
                TYPE IS (sparse_csc_c)
                    CALL CSPADD2_CSC(M, N, ALPHA, A, BETA, B, C, INFO)
                CLASS DEFAULT
                    INFO = -1
                END SELECT
            CLASS DEFAULT
...
CONTAINS
    ...
    SUBROUTINE CSPADD2_COO(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        COMPLEX(real32), INTENT(IN) :: ALPHA, BETA
    ...
    END SUBROUTINE CSPADD2_COO
    
    !> CSR addition implementation
    SUBROUTINE CSPADD2_CSR(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        COMPLEX(real32), INTENT(IN) :: ALPHA, BETA
    ...
    END SUBROUTINE CSPADD2_CSR
    
    !> CSC addition implementation
    SUBROUTINE CSPADD2_CSC(M, N, ALPHA, A, BETA, B, C, INFO)
        INTEGER(int32), INTENT(IN) :: M, N
        COMPLEX(real32), INTENT(IN) :: ALPHA, BETA
