...
SUBROUTINE SSPSIZE(FORMAT, SPARSE, NEW_NNZ, INFO)
...
CONTAINS
    ...
    SUBROUTINE DSPSIZE_COO(COO, NEW_SIZE, INFO)
        ...
        IF (ALLOCATED(COO%row_ind)) SEALLOCATE(COO%row_ind)
        IF (ALLOCATED(COO%col_ind)) SEALLOCATE(COO%col_ind)
        IF (ALLOCATED(COO%values)) SEALLOCATE(COO%values)
    ...
    SUBROUTINE DSPSIZE_CSR(CSR, NEW_SIZE, INFO)
        ...
        ! Deallocate old arrays
        IF (ALLOCATED(CSR%col_ind)) SEALLOCATE(CSR%col_ind)
        IF (ALLOCATED(CSR%values)) SEALLOCATE(CSR%values)
    ...
    SUBROUTINE DSPSIZE_CSC(CSC, NEW_SIZE, INFO)
        ...
        ! Deallocate old arrays
        IF (ALLOCATED(CSC%row_ind)) SEALLOCATE(CSC%row_ind)
        IF (ALLOCATED(CSC%values)) SEALLOCATE(CSC%values)
