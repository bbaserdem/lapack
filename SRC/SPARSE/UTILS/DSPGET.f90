...
!>          Can be TYPE(sparse_coo_d), TYPE(sparse_csr_d), or TYPE(sparse_csc_d).
!>
!> \param[in] I
!>          I is INTEGER
...
CONTAINS
    ...
    DOUBLE PRECISION FUNCTION DSPGET_COO(COO, I, J)
        TYPE(sparse_coo_d), INTENT(IN) :: COO
        INTEGER, INTENT(IN) :: I, J
        INTEGER :: k
        
        ! Initialize return value
        DSPGET_COO = 0.0_real64
    ...
    DOUBLE PRECISION FUNCTION DSPGET_CSR(CSR, I, J)
        TYPE(sparse_csr_d), INTENT(IN) :: CSR
        INTEGER, INTENT(IN) :: I, J
        INTEGER :: k, left, right, mid
        
        ! Initialize return value
        DSPGET_CSR = 0.0_real64
    ...
    DOUBLE PRECISION FUNCTION DSPGET_CSC(CSC, I, J)
        TYPE(sparse_csc_d), INTENT(IN) :: CSC
        INTEGER, INTENT(IN) :: I, J
        INTEGER :: k, left, right, mid
        
        ! Initialize return value
        DSPGET_CSC = 0.0_real64
