...
SUBROUTINE ZSPADD2(FORMAT, M, N, ALPHA, A, BETA, B, C, INFO)
...
CONTAINS
    ...
    SUBROUTINE ZSPADD2_COO(M, N, ALPHA, A, BETA, B, C, INFO)
        ...
        TYPE(sparse_coo_z), INTENT(OUT) :: C
        INTEGER(int32), INTENT(OUT) :: INFO
        ...
        ! Special cases
        IF (ALPHA == (0.0_real64, 0.0_real64) .AND. BETA == (0.0_real64, 0.0_real64)) THEN
            ! C = 0
            C%nrows = M
            C%ncols = N
            C%nnz = 0
    ...
    SUBROUTINE ZSPADD2_CSC(M, N, ALPHA, A, BETA, B, C, INFO)
        ...
        TYPE(sparse_csc_z), INTENT(OUT) :: C
        INTEGER(int32), INTENT(OUT) :: INFO
