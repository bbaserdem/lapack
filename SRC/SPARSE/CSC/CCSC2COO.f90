!> \brief \b CCSC2COO converts CSC to COO format
!>
!> \par Purpose:
!> =============
!>
!> CCSC2COO converts a sparse matrix from CSC (Compressed Sparse Column) format
...
SUBROUTINE CCSC2COO(CSC, COO, INFO)
    ...
    CO j = 1, CSC%ncols
        ...
        CO i = CSC%col_ptr(j), CSC%col_ptr(j+1)-1
