...
SUBROUTINE CCSCALLOC(NROWS, NCOLS, NNZ, CSC, INFO)
    ...
    TYPE(sparse_csc_c), INTENT(OUT) :: CSC
...
SUBROUTINE CCSCINIT(COLPTR, ROWIND, VAL, NCOLS, NNZ, CSC, INFO)
    USE sparse_types_extended
    USE sparse_constants
    IMPLICIT NONE
