!> \brief \b SCSC2COO converts CSC to COO format
!>
!> \par Purpose:
!> =============
!>
!> SCSC2COO converts a sparse matrix from CSC (Compressed Sparse Column) format
...
SUBROUTINE SCSC2COO(CSC, COO, INFO)
    ...
    SO j = 1, CSC%ncols
        ...
        SO i = CSC%col_ptr(j), CSC%col_ptr(j+1)-1
