...
SUBROUTINE DCSRALLOC(NROWS, NCOLS, NNZ, CSR, INFO)
    USE sparse_types
    ...
    TYPE(sparse_csr_d), INTENT(OUT) :: CSR
...
SUBROUTINE DCSRINIT(ROWPTR, COLIND, VAL, NROWS, NNZ, CSR, INFO)
    USE sparse_types
    USE sparse_constants
    IMPLICIT NONE
    ...
    TYPE(sparse_csr_d), INTENT(INOUT) :: CSR
    INTEGER, INTENT(OUT) :: INFO
