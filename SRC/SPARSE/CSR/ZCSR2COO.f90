!> \brief \b ZCSR2COO converts CSR to COO format
!>
!> \par Purpose:
!> =============
!>
!> ZCSR2COO converts a sparse matrix from CSR (Compressed Sparse Row) format
...
SUBROUTINE ZCSR2COO(CSR, COO, INFO)
    ...
    ZO i = 1, CSR%nrows
        ...
        ZO j = CSR%row_ptr(i), CSR%row_ptr(i+1)-1
