...
SUBROUTINE ZCSRCSC(TRANSA, TRANSB, M, N, K, ALPHA, A, B, BETA, C)
    ...
    TYPE(sparse_csr_z), INTENT(IN) :: A
    TYPE(sparse_csc_z), INTENT(IN) :: B
    TYPE(sparse_csr_z), INTENT(INOUT) :: C
...
CONTAINS
    ...
    SUBROUTINE resize_csr(mat, new_size)
        TYPE(sparse_csr_z), INTENT(INOUT) :: mat
