!> \brief \b SCOOCHECK validates COO sparse matrix structure
!>
!> \par Purpose:
!> =============
!>
!> SCOOCHECK validates a COO sparse matrix structure by checking:
