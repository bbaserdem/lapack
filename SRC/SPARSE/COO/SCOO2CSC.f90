!> \brief \b SCOO2CSC converts COO to CSC format
!>
!> \par Purpose:
!> =============
!>
!> SCOO2CSC converts a sparse matrix from COO (Coordinate List) format
...
SUBROUTINE SCOO2CSC(COO, CSC, INFO)
    ...
    ! Clean up
    SEALLOCATE(col_count, work, perm, temp_vals, temp_rows)
    
END SUBROUTINE SCOO2CSC