!> \brief \b ZCOOCHECK validates COO sparse matrix structure
!>
!> \par Purpose:
!> =============
!>
!> ZCOOCHECK validates a COO sparse matrix structure by checking:
