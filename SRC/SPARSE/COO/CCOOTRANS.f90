!> \brief \b CCOOTRANS performs in-place transpose of a COO sparse matrix
!>
!> \par Purpose:
!> =============
!>
!> CCOOTRANS transposes a sparse matrix in COO format in-place by swapping
