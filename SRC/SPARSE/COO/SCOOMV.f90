!> \brief \b SCOOMV performs matrix-vector multiplication using COO format
!>
!> \par Purpose:
!> =============
!>
!> SCOOMV performs one of the matrix-vector operations
!>
...
SUBROUTINE SCOOMV(TRANS, M, N, ALPHA, COO, X, INCX, BETA, Y, INCY)
