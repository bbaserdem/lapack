!> \brief \b SCOOTRANS performs in-place transpose of a COO sparse matrix
!>
!> \par Purpose:
!> =============
!>
!> SCOOTRANS transposes a sparse matrix in COO format in-place by swapping
