!> \brief \b SCOOALLOC allocates a COO sparse matrix
!>
!> \par Purpose:
!> =============
!>
!> SCOOALLOC allocates memory for a COO format sparse matrix with specified
...
!> \brief \b SCOOINIT initializes a COO sparse matrix from arrays
!>
!> \par Purpose:
!> =============
!>
!> SCOOINIT initializes a COO format sparse matrix from provided arrays
...
!>
!> \param[in] VAL
!>          VAL is REAL array, dimension (NNZ)
!>          The non-zero values.
!>
!> \param[in] NNZ
!>          NNZ is INTEGER
